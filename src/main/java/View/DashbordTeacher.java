 ...
 * @author User
 */
public class DashbordTeacher extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DashbordTeacher.class.getName());

    /**
     * Creates new form DashbordStudent
     */
    public DashbordTeacher() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DashbordTeacher().setVisible(true));
    }
