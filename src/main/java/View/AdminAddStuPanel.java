...
public class AdminAddStuPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jlbregistrationdate.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(cmbClass, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(txtclear, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                        .addGap(24, 24, 24))))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTxtaddress, javax.swing.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
// Controller එකට JTable එක ලබාදීම සඳහා මෙය AdminAddStuPanel එක තුළ තිබිය යුතුය
 ...
 // 1. Controller එකට දත්ත ලබා දෙන getStudentData Method එක
    public Model.dto.StudentDto getStudentData() {
        
        String selectedClassId = null;
        String selectedClassName = null; 
        
        Object selectedItem = cmbClass.getSelectedItem();
        
        // අනිවාර්යයෙන්ම තෝරාගත් දේ ClassEntity එකක්දැයි පරීක්ෂා කිරීම
        if (selectedItem instanceof Model.entity.ClassEntity) {
            Model.entity.ClassEntity selectedClass = (Model.entity.ClassEntity) selectedItem;
            selectedClassId = selectedClass.getClassId();     // ID එක වෙන් කර ගැනීම (උදා: C001)
            selectedClassName = selectedClass.getClassName(); // නම වෙන් කර ගැනීම (උදා: Grade 10 - A)
        } else {
            // වැරදීමකින් හෝ String එකක් පැමිණියහොත් එය Console එකේ පෙන්වීමට
            System.out.println("Warning: Selected item is not a ClassEntity! It is: " + selectedItem);
        }

        Model.dto.StudentDto dto = new Model.dto.StudentDto(
            stuid.getText(),
            jTxtname.getText(),
            ...
            selectedClassId, // DTO එකට යවන්නේ ID එක පමණි
            jTxtpsw.getText(),
            jComboBoxstatus.getSelectedItem().toString()
        );
        
        // Email එක සඳහා Class Name එක වෙනම සෙට් කිරීම
        dto.setClassName(selectedClassName);
   ...
   public void setStudentData(Model.dto.StudentDto dto) {
        ...
        // අදාළ පන්තිය Combo Box එකේ ස්වයංක්‍රීයව Select වීම
        for (int i = 0; i < cmbClass.getItemCount(); i++) {
            Object item = cmbClass.getItemAt(i);
            if (item instanceof Model.entity.ClassEntity) {
                if (((Model.entity.ClassEntity) item).getClassId().equals(dto.getClassId())) {
    ...
    public void loadClassesToComboBox() {
        Model.dao.AdminClassDAO classDAO = new Model.dao.AdminClassDAO();
        java.util.List<Model.entity.ClassEntity> classes = classDAO.getAllClasses();
        
        // NetBeans හි JComboBox<String> ගැටළුව මඟහරවා Object දැමීම සඳහා DefaultComboBoxModel භාවිතා කිරීම
        javax.swing.DefaultComboBoxModel model = new javax.swing.DefaultComboBoxModel();
        
        for (Model.entity.ClassEntity c : classes) {
            model.addElement(c); 
        }
