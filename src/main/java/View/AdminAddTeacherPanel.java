...
public class AdminAddTeacherPanel extends javax.swing.JPanel {
...
public javax.swing.JTable getTable() {
    ...
    public void loadAutoGeneratedId() {
        try {
            Model.dao.AdminTeacherDAO dao = new Model.dao.AdminTeacherDAO();
            stuid.setText(dao.generateNextTeacherId()); 
        } catch (Exception e) { 
            e.printStackTrace(); 
        }
    }
    ...
    // Controller
    public Model.dto.TeacherDto getTeacherData() {
        return new Model.dto.TeacherDto(
            stuid.getText(),
            jTxtname.getText(),
            jTxtNIC.getText(),
    ...
    // Search 
    public void setTeacherData(Model.dto.TeacherDto dto) {
        stuid.setText(dto.getTeacherId());
